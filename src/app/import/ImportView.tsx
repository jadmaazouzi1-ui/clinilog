                  ...
                  return (
                    <tr
                      ...
                      style={{
                        ...
                        backgroundColor: hasError ? "rgba(255,71,87,0.05)" : (r.selected ? "rgba(232,160,32,0.03)" : "transparent"),
                      }}
                    >
                      ...
                      <td className="px-2 py-3 align-top">
                        <p className="font-medium" style={{ color: hasError ? "rgba(255,71,87,0.85)" : "#FFFFFF" }}>
                          {r.row?.title || r.raw[0] || "—"}
                        </p>
                        {hasError && (
