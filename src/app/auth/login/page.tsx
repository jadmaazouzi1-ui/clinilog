          ...
          {sent === "1" ? (
            <div className="glass-card rounded-2xl p-8 text-center">
              <div
                ...
                style={{ backgroundColor: "rgba(26,107,255,0.1)", border: "1px solid rgba(26,107,255,0.25)" }}
              >
                <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="#1A6BFF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
                  <polyline points="22,6 12,13 2,6" />
                </svg>
              </div>
              <h2 className="text-lg font-bold mb-2" style={{ color: "#0D0D0D" }}>
                Check your email
              </h2>
              <p className="text-sm mb-6 leading-relaxed" style={{ color: "rgba(13,13,13,0.6)" }}>
                We sent a password reset link to your email address. It may take a minute to arrive.
              </p>
              <Link href="/auth/login" className="text-sm font-medium" style={{ color: "#1A6BFF" }}>
                ← Back to sign in
              </Link>
            </div>
          ) : (
            <>
              <div className="text-center mb-8">
                <h1 className="text-2xl font-bold" style={{ color: "#0D0D0D" }}>Reset your password</h1>
              ...
              <div className="glass-card rounded-2xl p-8">
                ...
                <form action={forgotPassword} className="space-y-5">
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium mb-1.5" style={{ color: "rgba(13,13,13,0.85)" }}>
                      Email address
                    </label>
                    <input
                      id="email"
  ...
  return (
    <div className="min-h-screen dot-grid-bg flex items-center justify-center px-4" style={{ backgroundColor: "#F8F9FA" }}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <LogoMark />
          <h1 className="text-2xl font-bold" style={{ color: "#0D0D0D" }}>Welcome back</h1>
          <p className="text-sm mt-1" style={{ color: "rgba(13,13,13,0.6)" }}>
          ...
          <form action={login} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="password" className="block text-sm font-medium" style={{ color: "rgba(13,13,13,0.85)" }}>
                  Password
                </label>
                <Link href="/auth/login?view=forgot" className="text-xs font-medium" style={{ color: "#1A6BFF" }}>
                  Forgot password?
                </Link>
              </div>
              <input
        ...
        <p className="text-center text-sm mt-6" style={{ color: "rgba(13,13,13,0.5)" }}>
          ...
          <Link href="/auth/signup" className="font-medium" style={{ color: "#1A6BFF" }}>
            Create one free
          </Link>
        </p>
      </div>
