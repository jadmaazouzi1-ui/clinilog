      ...
      >
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/resources" className="text-sm font-medium" style={{ color: "rgba(248,250,252,0.7)" }}>
              Resources
            </Link>
            <Link href="/fee-tracker" className="text-sm font-medium" style={{ color: "#00D4FF" }}>
              Fee Tracker
            </Link>
