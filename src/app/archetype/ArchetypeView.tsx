...
export default function ArchetypeView({ initialAnalysis, experienceCount, generatedAt: initialGeneratedAt }: Props) {
  ...
  if (experienceCount < 3) {
    return (
      <div className="glass-card rounded-2xl p-10 text-center">
        ...
        <h1 className="text-xl font-bold mb-2" style={{ color: "#0D0D0D" }}>Almost there</h1>
        <p className="text-sm mb-6 max-w-md mx-auto" style={{ color: "rgba(13,13,13,0.6)" }}>
      ...
      <div className="glass-card rounded-2xl p-12 text-center">
        <div className="relative w-20 h-20 mx-auto mb-6">
          ...
          <div
            ...
            style={{ backgroundColor: "#1A6BFF", boxShadow: "0 0 30px rgba(26,107,255,0.6)" }}
          >
        ...
        <h1 className="text-xl font-bold mb-2" style={{ color: "#0D0D0D" }}>
          Analyzing your experiences…
        </h1>
        <p className="text-sm max-w-md mx-auto" style={{ color: "rgba(13,13,13,0.55)" }}>
  ...
  if (error && !analysis) {
    return (
      <div className="glass-card rounded-2xl p-10 text-center">
        ...
        <p className="text-sm mb-6 max-w-md mx-auto" style={{ color: "rgba(13,13,13,0.6)" }}>{error}</p>
        <button
          onClick={runAnalysis}
          className="inline-flex items-center gap-2 teal-glow px-5 py-2.5 rounded-xl font-semibold text-sm"
          style={{ backgroundColor: "#1A6BFF", color: "#FFFFFF" }}
  ...
  function downloadCard() {
    ...
    // Dot grid
    ctx.fillStyle = "rgba(26,107,255,0.12)";
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="relative">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold mb-2" style={{ color: "#0D0D0D" }}>
            {archetype.name}
          </h1>
          <p className="text-base italic mb-4" style={{ color }}>
            &ldquo;{archetype.tagline}&rdquo;
          </p>
          <p className="text-sm leading-relaxed max-w-xl mx-auto" style={{ color: "rgba(13,13,13,0.7)" }}>
          ...
          <div className="flex items-center justify-center gap-3 mt-6 flex-wrap">
            ...
            <button
              ...
              style={{ color: "#1A6BFF", border: "1px solid rgba(26,107,255,0.35)", background: "rgba(26,107,255,0.06)" }}
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {generatedAt && (
            <p className="text-xs mt-3" style={{ color: "rgba(13,13,13,0.35)" }}>
      ...
      <Section title="Why This Archetype" color={color}>
        <p className="text-sm leading-relaxed" style={{ color: "rgba(13,13,13,0.85)" }}>
        ...
        <ul className="space-y-3">
          {analysis.strengths.map((s, i) => (
            <li key={i} className="flex items-start gap-3">
              ...
              <span className="text-sm leading-relaxed" style={{ color: "rgba(13,13,13,0.85)" }}>{s}</span>
            </li>
          ))}
        </ul>
      </Section>
        ...
        <ul className="space-y-2">
          {archetype.idealSchools.map((s, i) => (
            <li
              ...
              style={{ backgroundColor: "rgba(26,107,255,0.04)", border: "1px solid rgba(26,107,255,0.1)" }}
            >
              <span
              ...
              <span className="text-sm font-medium" style={{ color: "#0D0D0D" }}>{s}</span>
            </li>
          ))}
        </ul>
        <Link
      ...
      <Section title="Your Ideal Personal Statement Angle" color={color}>
        <p className="text-sm leading-relaxed italic" style={{ color: "rgba(13,13,13,0.85)" }}>
        ...
        <ul className="space-y-3">
          {analysis.experiences_to_add.map((s, i) => (
            <li key={i} className="flex items-start gap-3">
              <div
                className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"
                style={{ backgroundColor: "rgba(13,13,13,0.06)", border: "1px solid rgba(13,13,13,0.2)" }}
              >
                <svg className="w-3 h-3" fill="none" stroke="rgba(13,13,13,0.6)" strokeWidth="2.5" viewBox="0 0 24 24">
