  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: "rgba(0,0,0,0.75)" }}>
      <div
        ...
        style={{ backgroundColor: "rgba(255,255,255,0.98)", border: "1px solid rgba(26,107,255,0.2)" }}
      >
        {/* Close */}
        <button
        ...
        <h2 className="text-xl font-bold mb-1" style={{ color: "#0D0D0D" }}>Share Your Story</h2>
        <p className="text-sm mb-6" style={{ color: "rgba(13,13,13,0.55)" }}>
        ...
        <form action={submitStory} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium mb-1.5" style={{ color: "rgba(13,13,13,0.85)" }}>
          ...
          <div className="flex items-center justify-between gap-3 pt-2">
            <button
              ...
              style={{ color: "rgba(13,13,13,0.5)", border: "1px solid rgba(13,13,13,0.12)" }}
            >
              Cancel
            </button>
            <button
