...
const BADGE = { bg: "#FFFFFF", text: "#000000", border: "#000000" };
              ...
              <div key={s.name} className="glass-card rounded-2xl p-6 flex flex-col gap-4">
                ...
                <div className="flex items-center gap-4">
                  <div
                    ...
                    style={{ backgroundColor: badge.bg, border: `2px solid ${badge.border}`, color: "#000000" }}
                  >
                    {s.initial}
                  </div>
                  <div className="min-w-0">
                    <p className="font-semibold text-base" style={{ color: "#000000" }}>{s.name}</p>
                    <p className="text-xs truncate" style={{ color: "rgba(0,0,0,0.5)" }}>{s.undergrad}</p>
                  </div>
                </div>
                ...
                <blockquote
                  ...
                  style={{ color: "rgba(0,0,0,0.82)", borderColor: "#000000" }}
                >
                  &ldquo;{s.quote}&rdquo;
                </blockquote>
              </div>
