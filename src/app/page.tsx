    ...
    <>
      <style>{`
        ...
        @media (max-width: 767px) {
          ...
          .nav-grid { grid-template-columns: auto 2px 1fr; }
          .nav-right-divider { display: none; }
        }
      ...
      <div style={{ backgroundColor: "#FFFFFF", color: "#000000", minHeight: "100vh", fontFamily: "var(--font-inter, Inter, system-ui, sans-serif)" }}>
        ...
        <header style={{ position: "sticky", top: 0, zIndex: 50, backgroundColor: "#FFFFFF", borderBottom: "2px solid #000000" }}>
          <div className="nav-grid" style={{ height: 56 }}>
            ...
            <div className="nav-right-divider" style={{ background: "#000000" }} />
            {/* Right: auth */}
            <div style={{ display: "flex", alignItems: "center", gap: "1rem", padding: "0 1.5rem", justifyContent: "flex-end" }}>
        ...
        <section style={{ borderBottom: "2px solid #000000" }}>
          <div className="split-2col" style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            <div style={{ padding: "4.5rem 3rem 4.5rem 1.5rem" }}>
              ...
              <h1 style={{ fontSize: "clamp(3rem, 7vw, 5.5rem)", fontWeight: 900, lineHeight: 0.95, letterSpacing: "-0.03em", textTransform: "uppercase", marginBottom: "2rem" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
                <Link href="/auth/signup" className="invert-btn" style={{ fontSize: "0.875rem", padding: "0.875rem 1.75rem" }}>
                  Get started
                </Link>
                <Link href="/auth/login" className="ghost-btn" style={{ fontSize: "0.875rem", padding: "0.875rem 1.5rem" }}>
                  Sign in
                </Link>
              </div>
            </div>
